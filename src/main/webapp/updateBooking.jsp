...
.container {
  ...
  padding: 50px;
    ...
    <div class="main_content">
       ...
       <input type="text" id="ticket_ID" name="ticket_ID" value="<c:out value="${book.ticket_ID}"/>"readonly> 
      	
      	<label for="customer_ID"><b>Customer Id</b></label>
      	<input type="text" name="customer_ID" value="<c:out value="${book.customer_ID}"/>">
      
      	<label for="bus_ID"><b>Bus Id</b></label>
      	<input type="text"  name="bus_ID" value="<c:out value="${book.bus_ID}"/>">   
