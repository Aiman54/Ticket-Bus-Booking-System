...
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">ADD BUS</button>

<div id="id01" class="modal">
  
  <form class="modal-content animate" action="BusController" method="post">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <img src="image/tranbus.png" alt="Avatar" class="avatar">
    </div>
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Bas Status.." name="bus_status" required>

      <label for="bus_seatNum"><b>Bus Seat Number</b></label>
      <input type="text" placeholder="Bus Seat Number..." name="bus_seatNum" required>
      ...
      <input type="time" placeholder="Departure Time..." name="departure_time" required>

      <label for="destination"><b>Destination</b></label>
      <input type="text" placeholder="Destination..." name="destination" required>
      
      <label for="ticket_price"><b>Ticket Price</b></label>
      <input type="text" placeholder="Price..." name="ticket_price" required>
